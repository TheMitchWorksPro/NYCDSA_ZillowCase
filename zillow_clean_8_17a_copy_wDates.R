## made from copy of zillow_clean_08_17a.R
## changes:  modified inputs to join so that logerror is all logerrors, and TransactionDate is included
##           modified output filenames to be different from original 8_17a script
##           run both scripts and get 4 outputs
...
rm(lm1)
fwrite(full, 'clean_output_wDates.csv')  ## this is all of the data
## in this file:
...
fwrite(full_TrainTest, 'clean_TrainTest_output_wDates.csv')  ## this is all of the data
