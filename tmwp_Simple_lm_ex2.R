...
## is Lat/Long better than fips or zipcode?
...
modelxx = lm(logerror ~ taxamount + calculatedbathnbr + heatingorsystemtypeid +
               ...
               taxdelinquencyNoYrs + fireplacecnt + parcelid, data = trainSet1)
...
## [1] 0.0003305883    ## before parcelid
## [1] 0.0003275246    ## after adding parcelid
...
# Min.   : 10711725   Min.   :-4.60500   Min.   :-4.60500   Min.   :-4.60500   Min.   :-4.60500   Min.   :-4.60500   Min.   :-4.60500  
# 1st Qu.: 11643707   1st Qu.: 0.00546   1st Qu.: 0.00546   1st Qu.: 0.00546   1st Qu.: 0.00546   1st Qu.: 0.00546   1st Qu.: 0.00546  
# Median : 12545094   Median : 0.01136   Median : 0.01136   Median : 0.01136   Median : 0.01136   Median : 0.01136   Median : 0.01136  
# Mean   : 13325858   Mean   : 0.01108   Mean   : 0.01108   Mean   : 0.01108   Mean   : 0.01108   Mean   : 0.01108   Mean   : 0.01108  
# 3rd Qu.: 14097122   3rd Qu.: 0.01585   3rd Qu.: 0.01585   3rd Qu.: 0.01585   3rd Qu.: 0.01585   3rd Qu.: 0.01585   3rd Qu.: 0.01585  
# Max.   :169601949   Max.   : 4.73700   Max.   : 4.73700   Max.   : 4.73700   Max.   : 4.73700   Max.   : 4.73700   Max.   : 4.73700  
# > 

## write final answer for submission on Kaggle
fwrite(final_submission, 'submit_modX_ex2.csv')
...
# Overall
# taxamount             6.3616003
# calculatedbathnbr     8.9146352
# heatingorsystemtypeid 4.3125216
# numberofstories       0.8532187
# yearbuilt             1.2087214
# roomcnt               1.7732277
# poolcnt               5.4615708
# propertylandusetypeid 3.6403547
# regionidzip           2.4138397
# lotsizesqft_imputed   0.6061209
# taxdelinquencyNoYrs   6.2856901
# fireplacecnt          1.0636809
# parcelid              1.7536691
# >
...
#        fireplacecnt + parcelid, data = trainSet1)
# 
# Residuals:
#   Min      1Q  Median      3Q     Max 
# -4.6237 -0.0378 -0.0061  0.0275  4.7315 
# 
# Coefficients:
#   Estimate Std. Error t value Pr(>|t|)    
# (Intercept)           -2.324e-02  6.050e-02  -0.384 0.700871    
# taxamount             -6.720e-07  1.056e-07  -6.362 2.01e-10 ***
#   calculatedbathnbr      7.545e-03  8.464e-04   8.915  < 2e-16 ***
#   heatingorsystemtypeid -7.211e-04  1.672e-04  -4.313 1.62e-05 ***
#   numberofstories        2.175e-03  2.550e-03   0.853 0.393541    
# yearbuilt             -3.948e-05  3.266e-05  -1.209 0.226774    
# roomcnt                6.737e-04  3.799e-04   1.773 0.076196 .  
# poolcnt               -9.348e-03  1.712e-03  -5.462 4.74e-08 ***
#   propertylandusetypeid  5.097e-04  1.400e-04   3.640 0.000272 ***
#   regionidzip           -4.046e-07  1.676e-07  -2.414 0.015788 *  
#   lotsizesqft_imputed    3.280e-09  5.412e-09   0.606 0.544437    
# taxdelinquencyNoYrs    7.037e-03  1.119e-03   6.286 3.29e-10 ***
#   fireplacecnt           2.182e-03  2.051e-03   1.064 0.287477    
# parcelid               5.745e-10  3.276e-10   1.754 0.079492 .  
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.1613 on 63178 degrees of freedom
# Multiple R-squared:  0.003106,	Adjusted R-squared:  0.002901 
# F-statistic: 15.14 on 13 and 63178 DF,  p-value: < 2.2e-16
